...
% Track-changes markup via oztrackchanges (markup mode = review copy;
%   [accept] = clean copy). Compile: pdflatex -> bibtex -> pdflatex x2.
...
\usepackage{oztrackchanges}         % markup mode (default); [accept] -> clean copy
